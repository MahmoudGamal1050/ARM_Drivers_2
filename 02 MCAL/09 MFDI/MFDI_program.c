...
#include "MCAL/MFDI/MFDI_private.h"
#include "MCAL/MFDI/MFDI_config.h"
...
void MFDI_voidEraseAppArea(void)
{
	...
	u8 L_u8SectorIterator;

	for (L_u8SectorIterator=1 ; L_u8SectorIterator < 6 ; L_u8SectorIterator ++)
	{
		MFDI_voidEraseSector(L_u8SectorIterator);
	}
}
